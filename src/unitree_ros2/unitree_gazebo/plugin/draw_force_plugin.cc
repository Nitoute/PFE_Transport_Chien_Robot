...
namespace gazebo
{
    ...
    public:
        ...
        void Load(rendering::VisualPtr _parent, sdf::ElementPtr _sdf)
        {
            ...
            this->rosnode = rclcpp::Node::make_shared(this->visual_namespace);
            ...
            RCLCPP_INFO(rclcpp::get_logger("UnitreeDrawForcePlugin"), "Load %s Draw Force plugin.", this->topic_name.c_str());
        }

...
{
  new (message_memory) ros2_unitree_legged_msgs::msg::BmsState(_init);
}

void BmsState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_unitree_legged_msgs::msg::BmsState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BmsState_message_member_array[9] = {
  {
    ...
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, version_h),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, version_l),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, bms_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, soc),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, current),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, cycle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, bq_ntc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, mcu_ntc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    10,  // array size
    false,  // is upper bound
    offsetof(ros2_unitree_legged_msgs::msg::BmsState, cell_vol),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BmsState_message_members = {
  ...
  9,  // number of fields
  sizeof(ros2_unitree_legged_msgs::msg::BmsState),
...
{
  return &::ros2_unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::BmsState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_unitree_legged_msgs, msg, BmsState)() {
  return &::ros2_unitree_legged_msgs::msg::rosidl_typesupport_introspection_cpp::BmsState_message_type_support_handle;
}

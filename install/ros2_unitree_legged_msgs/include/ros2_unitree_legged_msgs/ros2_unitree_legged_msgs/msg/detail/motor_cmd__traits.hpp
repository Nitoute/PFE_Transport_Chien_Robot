...
#ifndef ROS2_UNITREE_LEGGED_MSGS__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
#define ROS2_UNITREE_LEGGED_MSGS__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
...
inline void to_yaml(
  const ros2_unitree_legged_msgs::msg::MotorCmd & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ros2_unitree_legged_msgs::msg::MotorCmd & msg)
{
  return ros2_unitree_legged_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<ros2_unitree_legged_msgs::msg::MotorCmd>()
{
  return "ros2_unitree_legged_msgs::msg::MotorCmd";
}

template<>
inline const char * name<ros2_unitree_legged_msgs::msg::MotorCmd>()
{
  return "ros2_unitree_legged_msgs/msg/MotorCmd";
}

template<>
struct has_fixed_size<ros2_unitree_legged_msgs::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<ros2_unitree_legged_msgs::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<ros2_unitree_legged_msgs::msg::MotorCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROS2_UNITREE_LEGGED_MSGS__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_

...
bool ros2_unitree_legged_msgs__msg__motor_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool ros2_unitree_legged_msgs__msg__low_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_unitree_legged_msgs.msg._low_cmd.LowCmd", full_classname_dest, 44) == 0);
  }
  ros2_unitree_legged_msgs__msg__LowCmd * ros_message = _ros_message;
  {  // head
  ...
  {  // motor_cmd
    ...
    Py_ssize_t size = 20;
    ros2_unitree_legged_msgs__msg__MotorCmd * dest = ros_message->motor_cmd;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ros2_unitree_legged_msgs__msg__motor_cmd__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * ros2_unitree_legged_msgs__msg__low_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_unitree_legged_msgs.msg._low_cmd");
  ...
  {  // motor_cmd
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ros2_unitree_legged_msgs__msg__motor_cmd__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }

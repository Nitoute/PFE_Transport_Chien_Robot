...
static const _IMU_type_support_symbol_names_t _IMU_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_unitree_legged_msgs, msg, IMU)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_unitree_legged_msgs, msg, IMU)),
  }
};
...
{
  return &::ros2_unitree_legged_msgs::msg::rosidl_typesupport_cpp::IMU_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_unitree_legged_msgs, msg, IMU)() {
  return get_message_type_support_handle<ros2_unitree_legged_msgs::msg::IMU>();
}

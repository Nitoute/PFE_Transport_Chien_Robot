...
static const _NavToPose_Request_type_support_symbol_names_t _NavToPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_nav_interfaces, srv, NavToPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_nav_interfaces, srv, NavToPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unitree_nav_interfaces, srv, NavToPose_Request)() {
  return &::unitree_nav_interfaces::srv::rosidl_typesupport_c::NavToPose_Request_message_type_support_handle;
}
...
static const _NavToPose_Response_type_support_symbol_names_t _NavToPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_nav_interfaces, srv, NavToPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_nav_interfaces, srv, NavToPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unitree_nav_interfaces, srv, NavToPose_Response)() {
  return &::unitree_nav_interfaces::srv::rosidl_typesupport_c::NavToPose_Response_message_type_support_handle;
}
...
static const _NavToPose_type_support_symbol_names_t _NavToPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_nav_interfaces, srv, NavToPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_nav_interfaces, srv, NavToPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, unitree_nav_interfaces, srv, NavToPose)() {
  return &::unitree_nav_interfaces::srv::rosidl_typesupport_c::NavToPose_service_type_support_handle;
}

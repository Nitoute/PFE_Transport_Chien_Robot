...
#ifndef UNITREE_NAV_INTERFACES__SRV__DETAIL__NAV_TO_POSE__FUNCTIONS_H_
#define UNITREE_NAV_INTERFACES__SRV__DETAIL__NAV_TO_POSE__FUNCTIONS_H_
 ...
 * calls
 * unitree_nav_interfaces__srv__NavToPose_Request__init().
...
/**
 * It calls
 * unitree_nav_interfaces__srv__NavToPose_Request__fini()
...
/// Check for srv/NavToPose message equality.
/**
 ...
 * unitree_nav_interfaces__srv__NavToPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_nav_interfaces__srv__NavToPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/NavToPose message array equality.
/**
...
/// Copy an array of srv/NavToPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * unitree_nav_interfaces__srv__NavToPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_nav_interfaces
...
/**
 * It calls
 * unitree_nav_interfaces__srv__NavToPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_nav_interfaces
...
/**
 * It allocates the memory for the array and calls
 * unitree_nav_interfaces__srv__NavToPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_nav_interfaces
...
/**
 * It calls
 * unitree_nav_interfaces__srv__NavToPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UNITREE_NAV_INTERFACES__SRV__DETAIL__NAV_TO_POSE__FUNCTIONS_H_
